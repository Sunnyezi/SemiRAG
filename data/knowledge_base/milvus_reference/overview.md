...
> Note: the original Milvus workflow illustration is not included in this repository.
...
> Note: the original Milvus architecture illustration is not included in this repository.
